                    ...
                    <div class="col-md-6 my-4">
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <p class="card-text">Add .table-bordered for borders on all sides of the table and cells.
                                </p>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    <button class="btn btn-sm dropdown-toggle" type="button" id="dr2"
                                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <span class="text-muted sr-only">Action</span>
                                                    </button>
                    ...
                    <div class="col-md-6 my-4">
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <p class="card-text">Add .table-hover to enable a hover state on table rows within a
                                    <tbody>
                                </p>
                                <table class="table table-hover">
                    ...
                    <div class="col-md-6 my-4">
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <p class="card-text">Add .table-sm to make tables more compact by cutting cell padding in
                                    half.</p>
