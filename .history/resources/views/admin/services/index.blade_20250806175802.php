...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="page-title-pox d-sm-flex align-items-center justify-contect-between mb-3"></div>
                <h2 class="page-title">{{ __('keywords.service') }}</h2>
                <div class="page-title-right">
                    <a href="#" class="btn btn-sm btn-primary">{{ __('keywords.add_new') }}</a>
                </div>
                <!-- simple table -->
