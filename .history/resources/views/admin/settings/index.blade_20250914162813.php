        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card shadow">
                    ...
                    <form action="{{ route('admin.setting.update', ['setting' => $settings]) }}" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="address" id="address" class="form-control"
                                                placeholder="address" value="{{ $setting->title }}">
                                            @error('address')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="email" id="email" class="form-control"
                                                placeholder="email" value="{{ $setting->title }}">
                                            @error('email')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="phone" id="phone" class="form-control"
                                                placeholder="phone" value="{{ $setting->title }}">
                                            @error('phone')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="facebook" id="facebook" class="form-control"
                                                placeholder="facebook" value="{{ $setting->title }}">
                                            @error('facebook')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="youtube" id="youtube" class="form-control"
                                                placeholder="youtube" value="{{ $setting->title }}">
                                            @error('youtube')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="instagram" id="instagram" class="form-control"
                                                placeholder="instagram" value="{{ $setting->title }}">
                                            @error('instagram')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
