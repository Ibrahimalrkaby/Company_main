<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
    ...
    <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
            ...
            <ul class="navbar-nav flex-fill w-100 mb-2">
                <x-sidebar-tab href="{{ route('admin.message.index') }}" icon="fe-message-circle"
                    name="{{ __('keywords.message') }}"></x-sidebar-tab>
            </ul>
            <ul class="navbar-nav flex-fill w-100 mb-2">
                <x-sidebar-tab href="{{ route('admin.subscriber.index') }}" icon="fe-users"
                    name="{{ __('keywords.subscriber') }}"></x-sidebar-tab>
            </ul>
            <ul class="navbar-nav flex-fill w-100 mb-2">
                <x-sidebar-tab href="{{ route('admin.testimonials.index') }}" icon="fe-users"
