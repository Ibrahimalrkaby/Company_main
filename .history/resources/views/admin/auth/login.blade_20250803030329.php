...
<head>
    ...
    <title>{{ __('keywords.dashboard') }} - {{ __('keywords.sign_in') }}</title>
    <!-- Simple bar CSS -->
            ...
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST"
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="inputEmail" class="form-control form-control-lg"
                        placeholder="Email address" name="email" :value="old('{{ __('keywords.email') }}')">
                ...
                <div class="checkbox mb-3">
                    <label>
                        <input type="checkbox" value="remember-me" name="remember"> {{ __('keywords.remember_me') }}
                    </label>
                </div>
