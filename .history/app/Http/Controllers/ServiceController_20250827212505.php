...
class ServiceController extends Controller
{
    ...
    public function store(StoreServiceRequest $request)
    {
        ...
        Service::create($data);
        return to_route(self::Dir . 'index')->with('success', __('keywords.cerate_successfully'));
    }
    ...
    public function destroy(Service $service)
    {
        // dd($service);
        $service->delete();
        return redirect()->route(self::Dir . 'index')->with('success', __('keywords.deleted_successfully'));
    }
}
